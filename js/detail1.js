...
function loadDetail(){
          ...
          <div id="product-carousel" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner bg-light">
                  <div class="carousel-item active">
                      <img class="w-100 h-100" src="http://localhost:3000/images/${pro.img}" alt="Image">
                  </div>
      ...
      <div class="col-lg-7 h-auto mb-30">
          <div class="h-100 bg-light p-30">
              ...
              <div class="d-flex align-items-center mb-4 pt-2">
                  ...
                  <button class="btn btn-primary px-3" onclick = "themvaogio(${pro.id},'${pro.name}','${pro.image}',${pro.price})"><i class="fa fa-shopping-cart mr-1"></i> Add To
                      Cart</button>
              </div>
  ...
  <div class="row px-xl-5">
      <div class="col">
          <div class="bg-light p-30">
              ...
              <div class="tab-content">
                  <div class="tab-pane fade show active" id="tab-pane-1">
                      ...
                      <h7>${pro.detail}</h7>
                      <p>Đang cập nhật thêm thông tin</p>
                  </div>
        ...
        document.querySelector('#loadDetail').innerHTML += pro_arr.join('');
      })
  }
  loadDetail();